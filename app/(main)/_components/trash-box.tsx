...
<Input value={search} onChange={(e)=>e.target.value} className="h-7 px-2 focus-visible:ring-transparent bg-secondary" placeholder="filter by page tile..."/>
            </div>
